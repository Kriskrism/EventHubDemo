...
export class Mybookings{
    ...
    constructor(page : Page){
        ...
        this.viewDetailsBtn = page.getByRole('button', {name: /View Details|details/i}).first()
        this.cancelBooking = page.getByRole('button', {name: /Cancel Booking|cancel/i}).first()
        this.clearAllBooking = page.getByRole('button', {name: /Clear All|clear/i})
